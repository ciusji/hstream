...
data HStreamApi request response = HStreamApi{hstreamApiConnect ::
                                              request 'HsGRPC.Normal HStreamApi.CommandConnect
                                                HStreamApi.CommandConnected
                                                ->
                                                Hs.IO
...
hstreamApiServer HStreamApi{hstreamApiConnect = hstreamApiConnect}
