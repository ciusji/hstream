...
data HStreamApi request response = HStreamApi{hstreamApiConnect ::
                                              ...
                                              request 'HsGRPC.Normal
                                                Hstream.Server.HStreamApi.CommandQuery
                                                Hstream.Server.HStreamApi.CommandQueryResponse
                                                ->
                                                Hs.IO
                                                  (response 'HsGRPC.Normal
                                                     Hstream.Server.HStreamApi.CommandQueryResponse),
                                              hstreamApiCreateStreamTask ::
                                              request 'HsGRPC.Normal
                                                Hstream.Server.HStreamApi.CommandStreamTask
                                                Hstream.Server.HStreamApi.CommandStreamTaskResponse
                                                ->
                                                Hs.IO
                                                  (response 'HsGRPC.Normal
                                                     Hstream.Server.HStreamApi.CommandStreamTaskResponse)}
...
hstreamApiServer
  HStreamApi{hstreamApiConnect = hstreamApiConnect,
             ...
             hstreamApiCreateStreamTask = hstreamApiCreateStreamTask}
  ...
  = (HsGRPC.serverLoop
       HsGRPC.defaultOptions{HsGRPC.optNormalHandlers =
                               [(HsGRPC.UnaryHandler
                                ...
                                (HsGRPC.UnaryHandler
                                   (HsGRPC.MethodName "/hstream.server.HStreamApi/CreateStreamTask")
